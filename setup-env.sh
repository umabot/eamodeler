...
echo "     ./run.sh eamodeler --help"
echo ""
echo "  3. Generate interface documentation:"
echo "     ./run.sh eamodeler gen-interface-docs input/MDW-FLOW.csv APP_0100 --direction target"
echo ""
echo "  4. Compare MDW-FLOW vs RICEFW:"
echo "     ./run.sh eamodeler mdw-ricefw-diff input/MDW-FLOW.csv input/RICEFW_2026-03-30.csv"
echo ""